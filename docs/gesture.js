...
canvasPalace.prototype = {
    ...
    render: function() {
        ...
        $(document).ready(function($) {
            ...
            me.InitEvent(me.$palace, me.cxt);
            ////OW=2*offsetX+R*2*3+2*X
            me.draw(me.cxt, me.PointLocationArr, [], null);
        });
    },
    ...
    InitEvent: function(canvasContainer, cxt) {
        ...
        canvasContainer.on("touchstart", function(e) {
            ...
            //jquery写法等同如上
            console.log(touches)
            me.IsPointSelect(touches, me.LinePoint);
            ...
            me.draw(cxt, me.PointLocationArr, me.LinePoint, {
                X: touches.pageX,
                Y: touches.pageY
            });
            ...
            for (var i = 0; i < me.LinePoint.length; i++) {
                password[i] = me.LinePoint[i] + 1;
            }
            ...
            if (password.length < 4) {
                cxt.clearRect(0, 0, me.config.OW, me.config.OH);
                me.draw(cxt, me.PointLocationArr, me.LinePoint, null, '#ff0000');
                alert('密码至少要4位');
                ...
                cxt.clearRect(0, 0, me.config.OW, me.config.OH);
                me.draw(cxt, me.PointLocationArr, me.LinePoint, null, '#00ff00');
                alert('密码正确');
            }
            me.LinePoint = [];
