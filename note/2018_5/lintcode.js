...
function computeProduct(unsorted) {
  var sorted_array = unsorted.sort(sortIntegers),
    ...
    product1 =
      sorted_array[array_n_element - 1] *
      sorted_array[0] *
      sorted_array[array_n_element - 2],
    product2 =
      sorted_array[0] * sorted_array[1] * sorted_array[array_n_element - 1];
...
console.log(getIntersection(ary1, ary2));
